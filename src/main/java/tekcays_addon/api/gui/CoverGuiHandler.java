...
public interface CoverGuiHandler {
    ...
    default void displayCurrentValue(List<ITextComponent> textList) {
        textList.add(new TextComponentString(
                String.format(getCurrentMeasureText(), getContainerMeasure(), getUnitSymbol())));
    }
    ...
    default ModularUI createUIHelper(EntityPlayer player) {
        ...
        TextFieldWidget2 textFieldWidget = new TextFieldWidget2(45, 26, 60, 20, convertThresholdToString(),
