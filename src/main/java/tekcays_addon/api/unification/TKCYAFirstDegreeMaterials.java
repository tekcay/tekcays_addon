...
public class TKCYAFirstDegreeMaterials {
    ...
    public static void init() {
        TKCYAMaterials.Stellite100 = new Material.Builder(3000, "stellite_100")
                .ingot().fluid()
        ...
        TKCYAMaterials.WatertightSteel = new Material.Builder(3001, "watertight_steel")
                .ingot().fluid()
        ...
        TKCYAMaterials.MaragingSteel300 = new Material.Builder(3002, "maraging_steel_300")
                .ingot().fluid()
        ...
        TKCYAMaterials.HastelloyC276 = new Material.Builder(3003, "hastelloy_c_276")
                .ingot().fluid()
        ...
        TKCYAMaterials.HastelloyX = new Material.Builder(3004, "hastelloy_x")
                .ingot().fluid()
        ...
        TKCYAMaterials.Trinaquadalloy = new Material.Builder(3005, "trinaquadalloy")
                .ingot().fluid()
        ...
        TKCYAMaterials.Zeron100 = new Material.Builder(3006, "zeron_100")
                .ingot().fluid()
        ...
        TKCYAMaterials.TitaniumCarbide = new Material.Builder(3007, "titanium_carbide")
                .ingot().fluid()
        ...
        TKCYAMaterials.TantalumCarbide = new Material.Builder(3008, "tantalum_carbide")
                .ingot().fluid()
        ...
        TKCYAMaterials.MolybdenumDisilicide = new Material.Builder(3009, "molybdenum_disilicide")
                .ingot().fluid()
