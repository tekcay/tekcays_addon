...
public class TKCYAPolymers {
    ...
    public static void init() {
        ...
        HighDensityPolyethylene = new Material.Builder(24700, "high_density_polyethylene")
                ...
                .flags(MaterialFlags.GENERATE_LONG_ROD, MaterialFlags.GENERATE_PLATE, MaterialFlags.NO_SMELTING,
                        MaterialFlags.NO_SMASHING, MaterialFlags.DISABLE_DECOMPOSITION, TKCYAMaterialFlags.POLYMER)
