...
public class FuelRecipeLogic extends AbstractRecipeLogic {
    ...
    public FuelRecipeLogic(MetaTileEntityLargeBoiler tileEntity) {
    ...
    protected void trySearchNewRecipe() {
        ...
        for (IFluidTank fluidTank : importFluids.getFluidTanks()) {
            ...
            /* Combustion fuels can't be used here
