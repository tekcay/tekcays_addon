package tekcays_addon.api.metatileentity.single;
...
public class SimpleNoEnergyMachineMetaTileEntity extends SimpleMachineMetaTileEntity {
    ...
    public SimpleNoEnergyMachineMetaTileEntity(ResourceLocation metaTileEntityId, RecipeMap<?> recipeMap, ICubeRenderer renderer, int tier, boolean hasFrontFacing) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new SimpleNoEnergyMachineMetaTileEntity(metaTileEntityId, workable.getRecipeMap(), renderer, getTier(), hasFrontFacing, getTankScalingFunction());
    }
