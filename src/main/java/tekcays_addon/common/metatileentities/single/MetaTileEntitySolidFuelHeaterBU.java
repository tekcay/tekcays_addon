...
public class MetaTileEntitySolidFuelHeaterBU extends MetaTileEntity implements IDataInfoProvider, IActiveOutputSide, IFuelable {
    ...
    public MetaTileEntitySolidFuelHeaterBU(ResourceLocation metaTileEntityId, FuelHeater fuelHeater) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new MetaTileEntitySolidFuelHeaterBU(metaTileEntityId, fuelHeater);
    }
