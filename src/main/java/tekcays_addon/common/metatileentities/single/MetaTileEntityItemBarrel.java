...
public class MetaTileEntityItemBarrel extends MetaTileEntity implements IActiveOutputSide {
    ...
    public MetaTileEntityItemBarrel(ResourceLocation metaTileEntityId, int tier, long maxStoredItems) {
