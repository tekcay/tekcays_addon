...
/**
 * Code taken from {@link MetaTileEntitySteamGrinder}
 */
public class MetaTileEntitySteamCrusher extends RecipeMapSteamMultiblockController {

    private static final int PARALLEL_LIMIT = 8;

    public MetaTileEntitySteamCrusher(ResourceLocation metaTileEntityId) {
        super(metaTileEntityId, TKCYARecipeMaps.CRUSHING, CONVERSION_RATE);
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity metaTileEntityHolder) {
        return new MetaTileEntitySteamCrusher(metaTileEntityId);
    }
