...
public class SteamAirCompressor extends MetaTileEntity implements IDataInfoProvider, IActiveOutputSide {
    ...
    public void renderMetaTileEntity(CCRenderState renderState, Matrix4 translation, IVertexOperation[] pipeline) {
        ...
        for (EnumFacing facing : EnumFacing.VALUES) {
            Textures.STEAM_CASING_BRONZE.renderSided(facing, renderState, translation, pipeline);
        }
    ...
    public Pair<TextureAtlasSprite, Integer> getParticleTexture() {
        return Pair.of(Textures.STEAM_CASING_BRONZE.getParticleSprite(), getPaintingColorForRendering());
    }
