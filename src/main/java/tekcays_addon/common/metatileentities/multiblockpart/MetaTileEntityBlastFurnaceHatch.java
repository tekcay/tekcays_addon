...
public class MetaTileEntityBlastFurnaceHatch extends MetaTileEntityMultiblockPart {

    private final BlockBrick.BrickType brick;

    public MetaTileEntityBlastFurnaceHatch(ResourceLocation metaTileEntityId, BlockBrick.BrickType brick) {
    ...
    public MetaTileEntity createMetaTileEntity(IGregTechTileEntity tileEntity) {
        return new MetaTileEntityBlastFurnaceHatch(metaTileEntityId, brick);
    }
