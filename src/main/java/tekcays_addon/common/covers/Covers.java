    ...
    public static void init() {
        ...
        registerBehavior(new ResourceLocation(TekCaysAddon.MODID, "temperature_detector"), COVER_TEMPERATURE_DETECTOR,
                (def, tile, side) -> new CoverDetector(def, tile, side,
                        new CoverDetectorWrapper(TEMPERATURE_DETECTOR_WRAPPER, DETECTOR_TEMPERATURE, (holderTile, attachedSide)
                                -> Objects.requireNonNull(holderTile.getCapability(CAPABILITY_HEAT_CONTAINER, attachedSide)).getTemperature())));

        registerBehavior(new ResourceLocation(TekCaysAddon.MODID, "speed_detector"), COVER_SPEED_DETECTOR,
                (def, tile, side) -> new CoverDetector(def, tile, side,
                        new CoverDetectorWrapper(SPEED_DETECTOR_WRAPPER, DETECTOR_SPEED, (holderTile, attachedSide)
                                -> Objects.requireNonNull(holderTile.getCapability(CAPABILITY_ROTATIONAL_CONTAINER, attachedSide)).getSpeed())));

        registerBehavior(new ResourceLocation(TekCaysAddon.MODID, "torque_detector"), COVER_TORQUE_DETECTOR,
                (def, tile, side) -> new CoverDetector(def, tile, side,
                        new CoverDetectorWrapper(TORQUE_DETECTOR_WRAPPER, DETECTOR_TORQUE, (holderTile, attachedSide)
                                -> Objects.requireNonNull(holderTile.getCapability(CAPABILITY_ROTATIONAL_CONTAINER, attachedSide)).getTorque())));

        registerBehavior(new ResourceLocation(TekCaysAddon.MODID, "rotation_power_detector"), COVER_ROTATION_POWER_DETECTOR,
                (def, tile, side) -> new CoverDetector(def, tile, side,
                        new CoverDetectorWrapper(ROTATION_POWER_DETECTOR_WRAPPER, DETECTOR_ROTATION_POWER, (holderTile, attachedSide)
                                -> Objects.requireNonNull(holderTile.getCapability(CAPABILITY_ROTATIONAL_CONTAINER, attachedSide)).getPower())));

        registerBehavior(new ResourceLocation(TekCaysAddon.MODID, "pressure_detector"), COVER_PRESSURE_DETECTOR,
                (def, tile, side) -> new CoverDetector(def, tile, side,
                        new CoverDetectorWrapper(PRESSURE_DETECTOR_WRAPPER, DETECTOR_PRESSURE, (holderTile, attachedSide)
                                -> Objects.requireNonNull(holderTile.getCapability(CAPABILITY_PRESSURE_CONTAINER, attachedSide)).getPressure())));
        ...
        registerBehavior(tkcyaId("conveyor.lv"), TKCYAMetaItems.CONVEYOR_MODULE_LV, (def, tile, side) -> new CoverConveyorOverhauled(def, tile, side, GTValues.LV, CoverMethods.getItemTransferRatePerSecond(1)));
        registerBehavior(tkcyaId("conveyor.mv"), TKCYAMetaItems.CONVEYOR_MODULE_MV, (def, tile, side) -> new CoverConveyorOverhauled(def, tile, side, GTValues.MV, CoverMethods.getItemTransferRatePerSecond(2)));
        registerBehavior(tkcyaId("conveyor.hv"), TKCYAMetaItems.CONVEYOR_MODULE_HV, (def, tile, side) -> new CoverConveyorOverhauled(def, tile, side, GTValues.HV, CoverMethods.getItemTransferRatePerSecond(3)));
        registerBehavior(tkcyaId("conveyor.ev"), TKCYAMetaItems.CONVEYOR_MODULE_EV, (def, tile, side) -> new CoverConveyorOverhauled(def, tile, side, GTValues.EV, CoverMethods.getItemTransferRatePerSecond(4)));
        registerBehavior(tkcyaId("conveyor.iv"), TKCYAMetaItems.CONVEYOR_MODULE_IV, (def, tile, side) -> new CoverConveyorOverhauled(def, tile, side, GTValues.IV, CoverMethods.getItemTransferRatePerSecond(5)));
        registerBehavior(tkcyaId("conveyor.luv"), TKCYAMetaItems.CONVEYOR_MODULE_LuV, (def, tile, side) -> new CoverConveyorOverhauled(def, tile, side, GTValues.LuV, CoverMethods.getItemTransferRatePerSecond(6)));
        registerBehavior(tkcyaId("conveyor.zpm"), TKCYAMetaItems.CONVEYOR_MODULE_ZPM, (def, tile, side) -> new CoverConveyorOverhauled(def, tile, side, GTValues.ZPM, CoverMethods.getItemTransferRatePerSecond(7)));
        registerBehavior(tkcyaId("conveyor.uv"), TKCYAMetaItems.CONVEYOR_MODULE_UV, (def, tile, side) -> new CoverConveyorOverhauled(def, tile, side, GTValues.UV, CoverMethods.getItemTransferRatePerSecond(8)));

        registerBehavior(tkcyaId("robotic_arm.lv"), TKCYAMetaItems.ROBOT_ARM_LV, (def, tile, side) -> new CoverRoboticArmOverhauled(def, tile, side, GTValues.LV, CoverMethods.getItemTransferRatePerSecond(1)));
        registerBehavior(tkcyaId("robotic_arm.mv"), TKCYAMetaItems.ROBOT_ARM_MV, (def, tile, side) -> new CoverRoboticArmOverhauled(def, tile, side, GTValues.MV, CoverMethods.getItemTransferRatePerSecond(2)));
        registerBehavior(tkcyaId("robotic_arm.hv"), TKCYAMetaItems.ROBOT_ARM_HV, (def, tile, side) -> new CoverRoboticArmOverhauled(def, tile, side, GTValues.HV, CoverMethods.getItemTransferRatePerSecond(3)));
        registerBehavior(tkcyaId("robotic_arm.ev"), TKCYAMetaItems.ROBOT_ARM_EV, (def, tile, side) -> new CoverRoboticArmOverhauled(def, tile, side, GTValues.EV, CoverMethods.getItemTransferRatePerSecond(4)));
        registerBehavior(tkcyaId("robotic_arm.iv"), TKCYAMetaItems.ROBOT_ARM_IV, (def, tile, side) -> new CoverRoboticArmOverhauled(def, tile, side, GTValues.IV, CoverMethods.getItemTransferRatePerSecond(5)));
        registerBehavior(tkcyaId("robotic_arm.luv"), TKCYAMetaItems.ROBOT_ARM_LuV, (def, tile, side) -> new CoverRoboticArmOverhauled(def, tile, side, GTValues.LuV, CoverMethods.getItemTransferRatePerSecond(6)));
        registerBehavior(tkcyaId("robotic_arm.zpm"), TKCYAMetaItems.ROBOT_ARM_ZPM, (def, tile, side) -> new CoverRoboticArmOverhauled(def, tile, side, GTValues.ZPM, CoverMethods.getItemTransferRatePerSecond(7)));
        registerBehavior(tkcyaId("robotic_arm.uv"), TKCYAMetaItems.ROBOT_ARM_UV, (def, tile, side) -> new CoverRoboticArmOverhauled(def, tile, side, GTValues.UV, CoverMethods.getItemTransferRatePerSecond(8)));

        registerBehavior(tkcyaId("pump.lv"), TKCYAMetaItems.ELECTRIC_PUMP_LV, (def, tile, side) -> new CoverPumpOverhauled(def, tile, side, GTValues.LV, CoverMethods.getFluidTransferRatePerSecond(1)));
        registerBehavior(tkcyaId("pump.mv"), TKCYAMetaItems.ELECTRIC_PUMP_MV, (def, tile, side) -> new CoverPumpOverhauled(def, tile, side, GTValues.MV, CoverMethods.getFluidTransferRatePerSecond(2)));
        registerBehavior(tkcyaId("pump.hv"), TKCYAMetaItems.ELECTRIC_PUMP_HV, (def, tile, side) -> new CoverPumpOverhauled(def, tile, side, GTValues.HV, CoverMethods.getFluidTransferRatePerSecond(3)));
        registerBehavior(tkcyaId("pump.ev"), TKCYAMetaItems.ELECTRIC_PUMP_EV, (def, tile, side) -> new CoverPumpOverhauled(def, tile, side, GTValues.EV, CoverMethods.getFluidTransferRatePerSecond(4)));
        registerBehavior(tkcyaId("pump.iv"), TKCYAMetaItems.ELECTRIC_PUMP_IV, (def, tile, side) -> new CoverPumpOverhauled(def, tile, side, GTValues.IV, CoverMethods.getFluidTransferRatePerSecond(5)));
        registerBehavior(tkcyaId("pump.luv"), TKCYAMetaItems.ELECTRIC_PUMP_LuV, (def, tile, side) -> new CoverPumpOverhauled(def, tile, side, GTValues.LuV, CoverMethods.getFluidTransferRatePerSecond(6)));
        registerBehavior(tkcyaId("pump.zpm"), TKCYAMetaItems.ELECTRIC_PUMP_ZPM, (def, tile, side) -> new CoverPumpOverhauled(def, tile, side, GTValues.ZPM, CoverMethods.getFluidTransferRatePerSecond(7)));
        registerBehavior(tkcyaId("pump.uv"), TKCYAMetaItems.ELECTRIC_PUMP_UV, (def, tile, side) -> new CoverPumpOverhauled(def, tile, side, GTValues.UV, CoverMethods.getFluidTransferRatePerSecond(8)));

        registerBehavior(tkcyaId("fluid.regulator.lv"), TKCYAMetaItems.FLUID_REGULATOR_LV, (def, tile, side) -> new CoverFluidRegulatorOverhauled(def, tile, side, GTValues.LV, CoverMethods.getFluidTransferRatePerSecond(1)));
        registerBehavior(tkcyaId("fluid.regulator.mv"), TKCYAMetaItems.FLUID_REGULATOR_MV, (def, tile, side) -> new CoverFluidRegulatorOverhauled(def, tile, side, GTValues.MV, CoverMethods.getFluidTransferRatePerSecond(2)));
        registerBehavior(tkcyaId("fluid.regulator.hv"), TKCYAMetaItems.FLUID_REGULATOR_HV, (def, tile, side) -> new CoverFluidRegulatorOverhauled(def, tile, side, GTValues.HV, CoverMethods.getFluidTransferRatePerSecond(3)));
        registerBehavior(tkcyaId("fluid.regulator.ev"), TKCYAMetaItems.FLUID_REGULATOR_EV, (def, tile, side) -> new CoverFluidRegulatorOverhauled(def, tile, side, GTValues.EV, CoverMethods.getFluidTransferRatePerSecond(4)));
        registerBehavior(tkcyaId("fluid.regulator.iv"), TKCYAMetaItems.FLUID_REGULATOR_IV, (def, tile, side) -> new CoverFluidRegulatorOverhauled(def, tile, side, GTValues.IV, CoverMethods.getFluidTransferRatePerSecond(5)));
        registerBehavior(tkcyaId("fluid.regulator.luv"), TKCYAMetaItems.FLUID_REGULATOR_LUV, (def, tile, side) -> new CoverFluidRegulatorOverhauled(def, tile, side, GTValues.LuV, CoverMethods.getFluidTransferRatePerSecond(6)));
        registerBehavior(tkcyaId("fluid.regulator.zpm"), TKCYAMetaItems.FLUID_REGULATOR_ZPM, (def, tile, side) -> new CoverFluidRegulatorOverhauled(def, tile, side, GTValues.ZPM, CoverMethods.getFluidTransferRatePerSecond(7)));
        registerBehavior(tkcyaId("fluid.regulator.uv"), TKCYAMetaItems.FLUID_REGULATOR_UV, (def, tile, side) -> new CoverFluidRegulatorOverhauled(def, tile, side, GTValues.UV, CoverMethods.getFluidTransferRatePerSecond(8)));
