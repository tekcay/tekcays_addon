...
public class ConverterHandler {
    ...
    public static void init() {
        ...
        CONVERTING_RECIPES.recipeBuilder()
                ...
                .intervalTemperature(new Integer[] { NickelZincFerrite.getFluid().getTemperature(),
                        Titanium.getFluid().getTemperature() + 500 })
                .pressurizedFluidStack(Oxygen.getFluid(1))
        ...
        CONVERTING_RECIPES.recipeBuilder()
                ...
                .intervalPressure(new Integer[] { ATMOSPHERIC_PRESSURE * 10, ATMOSPHERIC_PRESSURE * 15 })
                .intervalTemperature(new Integer[] { Titanium.getFluid().getTemperature(),
                        Titanium.getFluid().getTemperature() + 500 })
