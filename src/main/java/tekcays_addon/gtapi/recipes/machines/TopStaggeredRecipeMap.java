...
public class TopStaggeredRecipeMap<R extends RecipeBuilder<R>> extends RecipeMap<R> {
    ...
    public TopStaggeredRecipeMap(String unlocalizedName, int maxInputs, int maxOutputs, int maxFluidInputs,
                                 int maxFluidOutputs,
    ...
    public ModularUI.Builder createJeiUITemplate(IItemHandlerModifiable importItems, IItemHandlerModifiable exportItems,
        ...
        ModularUI.Builder builder = ModularUI.builder(GuiTextures.BACKGROUND, 176, 150)
                .widget(new ProgressWidget(200, 77, 1, 18, 18, GuiTextures.PROGRESS_BAR_ARROW,
