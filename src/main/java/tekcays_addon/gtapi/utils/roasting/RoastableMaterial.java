...
public class RoastableMaterial {
    ...
    public static final RoastableMaterial TETRAHEDRITE = new RoastableMaterial(Tetrahedrite, 800,
    ...
    public static final RoastableMaterial CHALCOPYRITE = new RoastableMaterial(Chalcopyrite, 1000,
            ATMOSPHERIC_PRESSURE * 4);
    public static final RoastableMaterial ARSENOPYRITE = new RoastableMaterial(Arsenopyrite, 1000,
            ATMOSPHERIC_PRESSURE * 2);

    public static final RoastableMaterial PENTLANDITE = new RoastableMaterial(Pentlandite, 1000,
    ...
    // With special output
    public static final RoastableMaterial CHALCOCITE = new RoastableMaterial(Chalcocite, 1000, ATMOSPHERIC_PRESSURE * 2,
            Cuprite);
    public static final RoastableMaterial MOLYBDENITE = new RoastableMaterial(Molybdenite, 1000,
            ATMOSPHERIC_PRESSURE * 2, MolybdenumTrioxide, MolybdenumFlue);
